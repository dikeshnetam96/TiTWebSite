...
export const metadata: Metadata = {
    title: "Employers — Under Maintenance",
    description: "Our Employers is temporarily unavailable while we make improvements.",
    robots: { index: false },
};
            ...
            <section className="mx-auto max-w-3xl">
                ...
                >
                    ...
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">
                        We’re polishing the Employers
                    </h1>

                    {/* Copy */}
                    <p className="mt-3 text-gray-600 dark:text-gray-400 leading-relaxed">
                        Our Employers is temporarily down while we roll out improvements.
