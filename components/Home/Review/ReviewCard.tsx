...
const ReviewCard = ({image,username,title,userRole}:Props) => {
  return (
    <div className="w-full lg:w-[60%] mx-auto">
      ...
      <p className="mt-4 text-center text-gray-600 dark:text-gray-400">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Delectus exercitationem, impedit nostrum reprehenderit odio ex placeat cum suscipit, numquam dolores maiores tenetur inventore necessitatibus provident dicta consequatur, laboriosam laudantium alias?</p>
