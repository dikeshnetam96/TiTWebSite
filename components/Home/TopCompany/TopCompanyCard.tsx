...
const TopCompanyCard = ({data}:Props) => {
  return <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 m-3">
    ...
    <div className="text-sm text-gray-500 dark:text-gray-400 items-center space-x-1 text-center justify-center mt-3">
        <GrLocation className="brand-text" />
        <p>{data.location}</p>
    </div>
    <div className="px-10 py-3 cursor-pointer transition-all duration-300 rounded-lg mt-4 text-sm text-center btn-secondary-brand">
